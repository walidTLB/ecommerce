...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Mon Profile || Produits Sportive</title>
  ...
  <body>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        ...
        <p><h4>Details de votre profile</h4></p>

        <p>ci-dessus votre informations , Si vous souhaitez de changer un champ il sefits d'entrez la nouvelle valeur,MERCI</p>
      </div>
    </div>
