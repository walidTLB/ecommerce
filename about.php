...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Nous || Produits Sportive</title>
  ...
  <body>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        <p>C'est un site web qu'est realiser par nous pour attend un objectif , Ce dernier conciste sur la facilite des achats en ligne pour notre clients , nous aimerons que ce site vous plair , MERCI 
        </p>
